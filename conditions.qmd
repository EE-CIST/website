...
L'ensemble des ressources présentées sur ce site web (cours, exercices, bases de données) peuvent être librement utilisées dans les conditions prévues par la licence **Creative Commons CC BY-SA 4.0 Deed**
...
Pour citer le site-internet : 
*Citation à venir...*


## Propriété intellectuelle des modules

Chaque module de cours est considéré comme un article scientifique qui doit  être cité selon les normes habituelles. Par exemple pour citer le module de statistique univariée : 
