...
<center><a href="https://tigr.netlify.app/" class="btn btn-warning" role="button" aria-disabled="true" target="_blank" rel="noopener noreferrer"><i class="bi bi-eye"></i> Consulter le site du module TIG'R</a></center>

Il est possible de récupérer les différentes leçons et exercices associés sur sa machine.

<center><a href="" class="btn btn-info" role="button" aria-disabled="true" target="_blank" rel="noopener noreferrer"><i class="bi bi-cloud-arrow-down"></i> R_lessons_pdf.zip</a></center>
