...
-   **Cours** : Introduction à l'ACP -- *cours adapté de Daniel J. Denis*
-   **TD**: ACP-CAH sur le développement des pays africains
-   **TD**: ACP-CAH sur les forces et faiblesses de la CEDEAO

<center><a href="https://ee-cist.github.io/EXP3-Multivar/Cours-CAH.html" class="btn btn-info" role="button" aria-disabled="true" target="_blank" rel="noopener noreferrer"><i class="bi bi-eye"></i> Suivre le cours et les TD en ligne </a></center>
...
5 exercices ont été construits sous R pour suivre ce module et sont téléchargeable ci-dessous. 
...
<center><a href="https://bit.ly/3DwvgjY" class="btn btn-warning" role="button" aria-disabled="true" target="_blank" rel="noopener noreferrer"><i class="bi bi-cloud-arrow-down"></i> Télécharger les exercices et les données </a></center>
